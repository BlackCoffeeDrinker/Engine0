...
macro(
    ...
    elseif (CMAKE_CXX_COMPILER_ID MATCHES ".*Clang|GNU")
        ...
        check_cxx_compiler_flag(-Wthread-safety THREAD_SAFETY)
        if (THREAD_SAFETY)
            set(NEW_COMPILE_OPTIONS "${NEW_COMPILE_OPTIONS} -Wthread-safety -D_LIBCPP_ENABLE_THREAD_SAFETY_ANNOTATIONS")
            message(STATUS "*** g++/clang -Wthread-safety enabled")
        else ()
            message(STATUS "*** g++/clang -Wthread-safety NOT enabled (not supported)")
        endif ()
