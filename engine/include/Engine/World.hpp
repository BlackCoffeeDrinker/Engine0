 ...
 * Generally, only a single World exists except during seamless
 * area transitions when both a destination and current world exists
 */
class World {
public:
  using NodeID = size_t;
...
public:
  ...
  [[nodiscard]] uint32_t NumActors() const;
