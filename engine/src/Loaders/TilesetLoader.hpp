...
class TilesetLoader : public ResourceLoader {
  ...
  error_code HandleTilesetSection(std::string_view key, std::string_view value);
  error_code HandleTileSpecificSection(TileIdType tileId, std::string_view key, std::string_view value);
