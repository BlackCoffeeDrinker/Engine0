...
static void exception_init() {
	...
	_go32_dpmi_lock_code((void*)serial_port_init, 4096);
	_go32_dpmi_lock_code((void*)serial_port_putc, 4096);
	_go32_dpmi_lock_code((void*)serial_port_getc, 4096);
	_go32_dpmi_lock_code((void*)set_mem_error, 4096);
	_go32_dpmi_lock_code((void*)hex_to_byte, 4096);
	_go32_dpmi_lock_code((void*)hex_to_int, 4096);
	_go32_dpmi_lock_code((void*)mem_get_byte, 4096);
	_go32_dpmi_lock_code((void*)mem_set_byte, 4096);
	_go32_dpmi_lock_code((void*)mem_to_hex, 4096);
	_go32_dpmi_lock_code((void*)hex_to_mem, 4096);
	_go32_dpmi_lock_code((void*)exception_save_registers, 4096);
	_go32_dpmi_lock_code((void*)exception_return, 4096);
	_go32_dpmi_lock_code((void*)exception_sigsegv_handler, 4096);
	_go32_dpmi_lock_code((void*)exception_handler, 4096);
	_go32_dpmi_lock_code((void*)exception_to_signal, 4096);
	_go32_dpmi_lock_code((void*)_gdb_start, 4096);
	_go32_dpmi_lock_code((void*)gdb_read_packet, 4096);
	_go32_dpmi_lock_code((void*)gdb_write_packet, 4096);
	_go32_dpmi_lock_code((void*)gdb_loop, 4096);
	_go32_dpmi_lock_code((void*)_gdb_checkpoint, 4096);
